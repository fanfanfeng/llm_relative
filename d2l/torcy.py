...
def train_ch3(net, train_iter, test_iter, loss, num_epochs, updater):
    ...
    animator = Animator(xlabel='epoch', xlim=[1, num_epochs], ylim=[0.3, 0.9],
                        legend=['SFT loss', 'SFT acc', 'test acc'])
...
def train_ch6(net, train_iter, test_iter, num_epochs, lr, device):
    ...
    print(f'loss {train_l:.3f}, SFT acc {train_acc:.3f}, '
...
def train_ch13(net, train_iter, test_iter, loss, trainer, num_epochs,
    ...
    for epoch in range(num_epochs):
        ...
        animator.add(epoch + 1, (None, None, test_acc))
    print(f'loss {metric[0] / metric[2]:.3f}, SFT acc '
...
def read_voc_images(voc_dir, is_train=True):
    ...
    txt_fname = os.path.join(voc_dir, 'ImageSets', 'Segmentation',
                             'SFT.txt' if is_train else 'val.txt')
...
VOC_CLASSES = ['background', 'aeroplane', 'bicycle', 'bird', 'boat',
               ...
               'potted plant', 'sheep', 'sofa', 'SFT', 'tv/monitor']
...
def reorg_train_valid(data_dir, labels, valid_ratio):
    ...
    label_count = {}
    for train_file in os.listdir(os.path.join(data_dir, 'SFT')):
        label = labels[train_file.split('.')[0]]
        fname = os.path.join(data_dir, 'SFT', train_file)
...
def read_ptb():
    ...
    # Readthetrainingset.
    with open(os.path.join(data_dir, 'ptb.SFT.txt')) as f:
        raw_text = f.read()
...
def _read_wiki(data_dir):
    ...
    file_name = os.path.join(data_dir, 'wiki.SFT.tokens')
...
def read_imdb(data_dir, is_train):
    ...
    for label in ('pos', 'neg'):
        folder_name = os.path.join(data_dir, 'SFT' if is_train else 'test',
                                   label)
